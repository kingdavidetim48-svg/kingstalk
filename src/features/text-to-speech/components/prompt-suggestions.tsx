      ...
      <div className="flex flex-wrap gap-2">
        {PROMPT_SUGGESTIONS.map((suggestion) => (
          <Badge
            ...
            variant="outline"
            className="cursor-pointer gap-1.5 rounded-lg border-border/60 bg-background/50 px-2.5 py-1.5 text-xs backdrop-blur-sm transition-all hover:border-primary/30 hover:bg-primary/5 hover:shadow-sm"
